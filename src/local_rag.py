# -------------------------------
# crowdfunding_rag_numeric_local.py
# -------------------------------
...
# Local LLM import
from langchain_community.llms import GPT4All  # For GGUF models
...
LOCAL_LLM_PATH = r"C:\Users\hp\Documents\Impactguru\models\Mistral-7B-Instruct-v0.3.Q4_K_S.gguf"
...
def get_insight_from_rag(vectorstore, embeddings, documents, numeric_aggregates, question, k=5, metadata_filter=None):
    ...
    # Otherwise, use semantic search + local LLM
    ...
    # Local Mistral 7B LLM via GPT4All
    
    llm = GPT4All(
    model="C:/Users/hp/Documents/Impactguru/models/Mistral-7B-Instruct-v0.3.Q4_K_S.gguf",
    backend="llama",        # use llama.cpp backend
...
""")
    ...
    answer_message = llm.generate([prompt_value.to_string()])
    answer_text = answer_message.generations[0][0].text
    return answer_text
# -------------------------------
# MAIN
# -------------------------------
